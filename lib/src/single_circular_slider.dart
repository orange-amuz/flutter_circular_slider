...
class SingleCircularSlider extends StatefulWidget {
  ...
  @override
  State<SingleCircularSlider> createState() => _SingleCircularSliderState();
}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
        ...
        child: CircularSliderPaint(
          ...
          baseColor:
              widget.baseColor ?? const Color.fromRGBO(255, 255, 255, 0.1),
          selectionColor:
              widget.selectionColor ?? const Color.fromRGBO(255, 255, 255, 0.3),
